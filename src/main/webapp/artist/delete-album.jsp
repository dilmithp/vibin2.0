...
<head>
    <meta charset="UTF-8">
    <title>Vibin - Delete Album</title>
...
<body class="bg-gray-900 text-white">
    <%
        ...
        // Get album ID from request parameter
    ...
    <main class="container mx-auto px-6 py-8">
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-gray-800 rounded-lg p-6 text-center">
                ...
                <p class="mb-6">Are you sure you want to delete the album "<%= album.getAlbumName() %>"? This action cannot be undone and will also remove all songs associated with this album.</p>
                ...
                <div class="flex justify-center space-x-4">
                    ...
                    <form action="<%=request.getContextPath()%>/artist/delete-album" method="post" class="inline">
